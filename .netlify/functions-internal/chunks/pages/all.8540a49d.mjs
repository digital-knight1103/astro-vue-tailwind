...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Test", "class": "astro-J7PV25F6" }, { "default": ($$result2) => renderTemplate`
	${renderComponent($$result2, "TheNavigation", TheNavigation, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Admin/Desktop/ASTRO+VUE/astro+vue+tailwind/src/components/TheNavigation.vue", "client:component-export": "default", "class": "astro-J7PV25F6" })}
	${renderComponent($$result2, "TheHeader", TheHeader, { "class": "astro-J7PV25F6" })}
	${renderComponent($$result2, "TheFeatures", TheFeatures, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Users/Admin/Desktop/ASTRO+VUE/astro+vue+tailwind/src/components/TheFeatures.vue", "client:component-export": "default", "class": "astro-J7PV25F6" })}
